...
final class FormatterTest extends TestCase
{
    ...
    public static function provideInlineStyleOptionsCases(): iterable
    {
        return [
            ...
            ['<fg=green;options=bold>', "\033[32;1mb\033[39;21m", 'b'],
            ['<fg=green;options=reverse;>', "\033[32;7m<a>\033[39;27m", '<a>'],
            ['<fg=green;options=bold,underscore>', "\033[32;1;4mz\033[39;21;24m", 'z'],
            ['<fg=green;options=bold,underscore,reverse;>', "\033[32;1;4;7md\033[39;21;24;27m", 'd'],
        ];
    }
